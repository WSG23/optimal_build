...
> Need the broader feature plan or next development step? See `docs/ROADMAP.MD` for strategic context and `docs/WORK_QUEUE.MD` for the current execution order.
