...
TAGS_METADATA: Final[list[dict[str, str]]] = [
    ...
    },
    {
        ...
        "description": (
            "Agent business performance APIs covering pipeline management, "
...
_ROUTER_MODULES: Final[tuple[str, ...]] = (
    ...
    "decisions",  # Decision-alternative provenance for preference training (PR2)
    "documents",  # Document corpus + extraction pipeline metadata (PR2)
)
