...
def downgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS rule_packs CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_alerts CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_ingestion_runs CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_cost_catalogs CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_cost_indices CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_ergonomics CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_products CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_material_standards CASCADE")

    op.execute("DROP INDEX IF EXISTS idx_geocode_cache_coords")
    op.execute("DROP INDEX IF EXISTS ix_ref_geocode_cache_address")
    op.execute("DROP TABLE IF EXISTS ref_geocode_cache CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_zoning_layers CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_parcels CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_documents CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS ref_sources CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS overlay_run_locks CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS overlay_decisions CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS overlay_suggestions CASCADE")
