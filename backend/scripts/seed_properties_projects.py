...
_PROPERTIES: Sequence[dict[str, object]] = (
    ...
    {
        "id": UUID("f2a9c1e5-3b7d-4c8f-9a2e-5d6b8e4f1a3c"),
        "name": "Commercial Bay",
        "address": "7 Queen Street, Auckland 1010, New Zealand",
        "postal_code": "1010",
        "jurisdiction_code": "NZ",
        "property_type": PropertyType.MIXED_USE,
        "status": PropertyStatus.EXISTING,
        "location": "SRID=4326;POINT(174.7660 -36.8432)",
        "district": "Auckland City Centre",
        "planning_area": "Auckland CBD",
        "land_area_sqm": Decimal("6200"),
        "gross_floor_area_sqm": Decimal("98000"),
        "net_lettable_area_sqm": Decimal("85000"),
        "building_height_m": Decimal("180"),
        "floors_above_ground": 39,
        "units_total": 28,
        "year_built": 2020,
        "tenure_type": TenureType.FREEHOLD,
        "zoning_code": "City Centre Zone",
