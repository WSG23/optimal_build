/**
 * @deprecated This file is deprecated. Use `@ob/tokens` for all design tokens.
 *
 * The canonical design tokens are now in `core/design-tokens/tokens.css`.
 * Import from `@ob/tokens` for TypeScript access:
 *
 * ```typescript
 * import { colors, typography, spacing, radii, cssVar } from '@ob/tokens'
 * ```
 *
 * This file is kept for backward compatibility with
 * theme/theme.ts but should not be used for new code.
 *
 * @see core/design-tokens/tokens.css - Single source of truth (CSS)
 * @see core/design-tokens/index.ts - TypeScript exports
 */
