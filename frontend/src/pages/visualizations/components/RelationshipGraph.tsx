...
function useForceSimulation(nodes: Node[], links: Link[], width: number, height: number) {
...
export function RelationshipGraph({ nodes, links, width = '100%', height = 400 }: RelationshipGraphProps) {
    ...
    >
       <svg width="100%" height="100%" viewBox={`0 0 ${dimensions.w} ${dimensions.h}`}>
           ...
           {nodes.map((node) => {
               ...
               const color = isTeam ? theme.palette.info.main : theme.palette.secondary.main;
