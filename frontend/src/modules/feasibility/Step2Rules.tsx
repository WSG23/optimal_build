...
export function Step2Rules({
  ...
  const landUseLabel = useMemo(
    () => t(`wizard.step1.landUseOptions.${project.landUse}`),
    [project.landUse, t],
  )
    ...
    <div className="feasibility-step">
      ...
      <section className="feasibility-panel">
          ...
          <div className="feasibility-panel__metrics">
            <div>
              <span className="feasibility-panel__metric-label">
                {t('wizard.step2.panel.metrics.siteArea')}
              </span>
            ...
            <div>
              <span className="feasibility-panel__metric-label">
                {t('wizard.step2.panel.metrics.landUse')}
              </span>
              <span className="feasibility-panel__metric-value">{landUseLabel}</span>
            </div>
            <div>
              <span className="feasibility-panel__metric-label">
                {t('wizard.step2.panel.metrics.targetGfa')}
              </span>
              <span className="feasibility-panel__metric-value">
            ...
            <div>
              <span className="feasibility-panel__metric-label">
                {t('wizard.step2.panel.metrics.targetHeight')}
              </span>
              <span className="feasibility-panel__metric-value">
        ...
        <div className="feasibility-panel__content">
          ...
          {!isLoading && !error && rules.length === 0 && <p>{t('wizard.step2.empty')}</p>}
      ...
      <div className="feasibility-actions">
        ...
        >
          {isEvaluating ? t('wizard.step2.actions.evaluating') : t('wizard.step2.actions.evaluate')}
        </button>
      </div>
    </div>
  )
