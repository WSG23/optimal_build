...
const IsometricIcon = ({ strategy, selected }: { strategy: GenerativeStrategy; selected: boolean }) => {
  const baseColor = selected ? '#06b6d4' : '#64748b'
  const highlightColor = selected ? '#22d3ee' : '#94a3b8'
  const shadowColor = selected ? 'rgba(6, 182, 212, 0.3)' : 'rgba(100, 116, 139, 0.2)'
  ...
  switch (strategy) {
    case 'max_density':
      ...
      return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          <defs>
            <filter id="glow-density" x="-50%" y="-50%" width="200%" height="200%">
          ...
          <g filter={selected ? 'url(#glow-density)' : undefined}>
            ...
            <path d="M24 4L32 10V38L24 32V4Z" fill={highlightColor} opacity="0.7" />
            {/* Side tower left */}
            <path d="M12 14L18 18V40L12 44L6 40V18L12 14Z" fill={baseColor} opacity="0.8" />
            {/* Side tower right */}
            <path d="M36 14L42 18V40L36 44L30 40V18L36 14Z" fill={baseColor} opacity="0.8" />
            {/* Windows */}
    ...
    case 'balanced':
      ...
      return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          <defs>
            <filter id="glow-balanced" x="-50%" y="-50%" width="200%" height="200%">
              <feGaussianBlur stdDeviation="2" result="coloredBlur" />
              <feMerge>
                <feMergeNode in="coloredBlur" />
                <feMergeNode in="SourceGraphic" />
          ...
          <g filter={selected ? 'url(#glow-balanced)' : undefined}>
            ...
            {/* Middle tier */}
            <path d="M12 24L24 18L36 24V36L24 42L12 36V24Z" fill={highlightColor} opacity="0.8" />
            {/* Top tier */}
            <path d="M16 16L24 12L32 16V28L24 32L16 28V16Z" fill={baseColor} />
            {/* Highlight */}
            <path d="M24 12L32 16V28L24 24V12Z" fill={highlightColor} opacity="0.5" />
    ...
    case 'iconic':
      ...
      return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          <defs>
            <filter id="glow-iconic" x="-50%" y="-50%" width="200%" height="200%">
              <feGaussianBlur stdDeviation="2" result="coloredBlur" />
              <feMerge>
                <feMergeNode in="coloredBlur" />
                <feMergeNode in="SourceGraphic" />
          ...
          <g filter={selected ? 'url(#glow-iconic)' : undefined}>
            {/* Curved iconic tower */}
            <path d="M24 2C24 2 32 8 34 16C36 24 36 32 34 40L24 46L14 40C12 32 12 24 14 16C16 8 24 2 24 2Z" fill={baseColor} />
            <path d="M24 2C24 2 32 8 34 16C36 24 36 32 34 40L24 34V2Z" fill={highlightColor} opacity="0.6" />
            {/* Crown feature */}
      ...
      return (
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          ...
          <g filter={selected ? 'url(#glow-green)' : undefined}>
            ...
            <path d="M24 20L38 28V44L24 36V20Z" fill={highlightColor} opacity="0.5" />
            {/* Green terraces */}
            <ellipse cx="16" cy="32" rx="4" ry="2" fill="#10b981" opacity="0.8" />
            <ellipse cx="32" cy="32" rx="4" ry="2" fill="#10b981" opacity="0.8" />
            <ellipse cx="24" cy="26" rx="5" ry="2" fill="#34d399" opacity="0.9" />
            {/* Trees/plants */}
            <circle cx="16" cy="30" r="2" fill="#059669" />
            <circle cx="32" cy="30" r="2" fill="#059669" />
            <circle cx="24" cy="24" r="2.5" fill="#10b981" />
            {/* Top garden */}
            <path d="M20 16L24 12L28 16C28 16 26 18 24 18C22 18 20 16 20 16Z" fill="#34d399" />
          </g>
        </svg>
      )
            ...
            <Grid item xs={6} key={option.value}>
              ...
              >
                ...
                >
                  ...
                  >
                    <IsometricIcon strategy={option.value} selected={isSelected} />
                  </Box>
