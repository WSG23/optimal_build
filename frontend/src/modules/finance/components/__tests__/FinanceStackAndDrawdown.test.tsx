...
describe('Finance capital stack and drawdown components', () => {
  ...
  it('renders the capital stack overview for scenarios with data', () => {
    ...
    assert.ok(screen.getByText('Visualizing data for'))
    assert.ok(screen.getAllByText('Scenario A').length > 0)
    assert.ok(screen.getByText('Scenario Comparison'))
  ...
  it('renders the drawdown table for scenarios with schedules', () => {
    ...
    assert.ok(screen.getByText(i18n.t('finance.drawdown.title')))
    assert.ok(screen.getByText('M1'))
    assert.ok(screen.getByText(i18n.t('finance.drawdown.headers.equity')))
  })
})
