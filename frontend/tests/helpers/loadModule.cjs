...
const moduleMap = new Map([
    [
        ...
        path.join(runtimeRoot, 'api', 'client.cjs'),
    ],
    [
        path.resolve(__dirname, '../../src/api/buildable.ts'),
        path.join(runtimeRoot, 'api', 'buildable.cjs'),
    ],
    [
        path.resolve(__dirname, '../../src/api/finance.ts'),
        path.join(runtimeRoot, 'api', 'finance.cjs'),
    ],
    [
    ...
    [
        ...
        path.join(runtimeRoot, 'router.cjs'),
    ],
])
